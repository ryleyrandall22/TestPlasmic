...
import sty from "./PlasmicButton.module.css"; // plasmic-import: jQm6kp0V2xX/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: tw1oSK1K5tE/icon
import Icon6Icon from "./icons/PlasmicIcon__Icon6"; // plasmic-import: QE3MAS9e5pJ/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__tiZUx)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon6Icon
                className={classNames(projectcss.all, sty.svg__ibnQ5)}
                role={"img"}
              />
            ),
